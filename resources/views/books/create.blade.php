...
@section('content')
    <div class="row">
        <div class="col-xl-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Book Create Form</h4>

                    @include('../layouts/alert')

                    <form class="needs-validation" method="POST" action="{{ route('books.create.store') }}">
                        @csrf
                        <div class="row mt-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control @error('book_title') is-invalid @enderror"
                                    id="book_title" value="{{ old('book_title') }}" placeholder="Enter Book Title"
                                    name="book_title">
                                @error('book_title')
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control @error('book_author') is-invalid @enderror"
                                    id="book_author" value="{{ old('book_author') }}" placeholder="Enter Book Author"
                                    name="book_author">
                                @error('book_author')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" class="form-control @error('book_price') is-invalid @enderror"
                                    id="book_price" value="{{ old('book_price') }}" placeholder="Enter Book Price"
                                    name="book_price">
                                @error('book_price')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" class="form-control @error('book_stock') is-invalid @enderror"
                                    id="book_stock" value="{{ old('book_stock') }}" placeholder="Enter Book Stock"
                                    name="book_stock">
                                @error('book_stock')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
